...
**Definition:** Progressive approach of previously distinct trajectories, expectations, or structural states toward a shared coordinate or bounded configuration.

**Triggers:** independent actors adopting increasingly similar positions; narrowing spreads between previously separated trajectories; repeated movement toward the same threshold, standard, protocol, or solution.

**Mechanics:** Distinct trajectories begin from separated positions but progressively reduce their structural distance as they respond to common constraints, incentives, information, or attractors.

**Examples:** leading AI developers independently moving toward third-party capability evaluations and shared safety thresholds; rival governments separately adopting compatible regulatory standards in response to the same systemic risk.
